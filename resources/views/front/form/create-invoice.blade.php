                ...
                <div class="primary-content" id="primary-content">
                    ...
                    <div class="form-group">
                        <div class="row ms-3">
                            ...
                            <div class="col-lg-4 col-12">
                                <input type="email" name="email" id="customerPhone" class="form-control" placeholder="Enter School/Company Name" value="{{ old('email') }}">
                    ...
                    <div class="form-group">
                        <div class="row ms-3">
                            ...
                            <div class="col-lg-4 col-12">
                                <input type="email" name="email" id="email" class="form-control" placeholder="Enter Address " value="{{ old('email') }}">
                                @error('email')
                                <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <table class="table table-bordered " id="dynamicTable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input name="total[]" type="number" class="form-control product-amount" readonly placeholder="Amount"></td>
                            <td><button type="button" class="btn btn-danger btn-sm delete-row">Remove</button></td>
                        </tr>
                    </tbody>
                </table>

                <!-- Inline Button & Subtotal -->
                <div class="d-flex justify-content-between align-items-center w-100">
                    <button type="button" class="btn btn-primary" id="addRowButton">Add New Item</button>
                    <label class="fw-bold">Subtotal: ₹<span id="subtotal">0.00</span></label>
                </div>
            </div>
            <!-- discount and tax  -->
            <div class="row my-3">
                <div class="col-lg-3">
                    ...
                    <div class="input-group">
                        <input type="number" name="discount" id="discount" class="form-control w-75" placeholder="Enter discount">
                        <select class="form-select w-25" id="discountUnit">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select w-25" id="discountUnit">
                            ...
                            <option value="rupees">VAT</option>
                        </select>
                    </div>
                </div>
        ...
        if (customerId) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.address) {
                        $('#email').val(data.address); // Fill address field
                    }
                },
                error: function() {
